...
def add_args(parser):
    ...
    group.add_argument('--pe-type', choices=('convwarp', 'vanilla'), default='vanilla', help='Type of encoding (default: %(default)s)')
    ...
    group.add_argument('--domain', choices=('hartley','fourier'), default='fourier', help='dummy argument (default: %(default)s)')
    group.add_argument('--activation', choices=('relu','leaky_relu'), default='relu', help='dummy argument (default: %(default)s)')
    return parser
